...
export const Icons = {
  ...
  Python: ({ size, height, width, ...props }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={size || height}
      width={size || width}
  ...
  Mongo: ({ size, height, width, ...props }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      aria-hidden="true"
      focusable="false"
  ...
  FastAPI: ({ size, height, width, ...props }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      aria-hidden="true"
